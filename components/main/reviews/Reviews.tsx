    ...
    <section id="reviews" className="py-20 bg-[#F8FBFB]">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto mb-12">
          {reviews.map((review) => (
            <div key={review._id} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-50 text-left flex flex-col justify-between hover:shadow-md transition-shadow">
              <div>
                {/* Star Ratings */}
